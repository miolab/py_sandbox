...
def test_boyer_moore_search_index__normal_case():
    # Normal case tests.
    assert StringSearchIndex.boyer_moore_search("abcdefg", "bc") == 1
    assert StringSearchIndex.boyer_moore_search("Hello world", "wor") == 6

    # Target substring does NOT exist case tests.
    assert StringSearchIndex.boyer_moore_search("abc", "xyz") == -1
    assert StringSearchIndex.boyer_moore_search("abc", "abcde") == -1
